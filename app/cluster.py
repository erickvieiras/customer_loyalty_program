...
def clustering(df1):
    ...
    df_cluster = pd.merge(df_cluster, df_avg_gross_revenue, como='inner', on='cluster')
    ...
    df_cluster = pd.merge(df_cluster, df_avg_recency_days, como='inner', on='cluster')
